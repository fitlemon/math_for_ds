...
class KNearestNeighbor:
    ...
    def compute_distances_two_loops(self, X):
        ...
        for i in range(num_test):
            for j in range(num_train):
                ...
                subtract =  self.X_train[j, :] - X[i, :]
                dists[i, j] = np.sum(np.dot(subtract, subtract))**0.5
    ...
    def compute_distances_one_loop(self, X):
        ...
        for i in range(num_test):
            ...
            #######################################################################
            # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            subtract =  X[i] - self.X_train
            dists[i, :] = np.sqrt(np.sum(np.square(subtract), axis=1))
            # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        return dists
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            #########################################################################
            # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            vals, counts = np.unique(self.y_train[closest_y], return_counts=True)
            mask = counts == np.max(counts)            
            y_pred[i] = vals[mask].min()
